...
The PICO 4 Pro and Enterprise are identifiable by its silver/gold reflective front,
but the PICO 4 Pro should have Chinese writing on the stickers underneath the facial interface,
and the PICO 4 Enterprise should have English writing on those stickers.
...
and the Business Settings can be accessed via Developer settings.
